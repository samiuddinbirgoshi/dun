...
export default function Hero() {
  ...
  const slides = [
    {
      image: "/1.jpg",
      title: " 3635 Dundas", // Proper space between words
      subtitle: "Discover Modern Living in the Heart of Toronto's Vibrant Junction Neighbourhood",
    },
  ];
          ...
          <div className="flex items-center justify-between">
            ...
            <Link href="/">
              <span className={`${isScrolled ? "text-xl font-medium  md:text-xl" : "text-xl md:text-xl"} tracking-tight text-white`}>
                3635  <span className="font-medium">Dundas</span>
              </span>
            </Link>
